...
class AnimatedProgressbar extends StatelessWidget {
  ...
  _colorGen(double value, BuildContext context) {
    // int rbg = (value * 255).toInt();
    // return Theme.of(context).primaryColorDark.withGreen(rbg).withRed(255 - rbg);
    return Theme.of(context).primaryColorLight.withOpacity(value);
  }
}
